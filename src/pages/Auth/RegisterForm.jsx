...
export default function RegisterForm() {
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://api.regeve.in/api/admin/requestOtp', requestData, {
        headers: {
  ...
  const verifyOtp = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://api.regeve.in/api/admin/verifyOtp', requestData, {
        headers: {
          'Content-Type': 'application/json',
        },
        timeout: 10000,
          ...
          <div className="bg-white rounded-lg p-8 max-w-md mx-4 transform transition-all duration-500 scale-100 animate-bounce-in">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Admin account has been created successfully. Please wait for approval.
              </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onBlur={handleBlur}
                className={`${inputClass} ${touched.companyName && errors.companyName ? 'border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className={`${inputClass} ${touched.name && errors.name ? 'border-red-500' : ''}`}
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} flex-1 ${touched.email && errors.email ? 'border-red-500' : ''}`}
                ...
                <button
                  type="button"
                  onClick={sendOtp}
                  disabled={!formData.email || errors.email || isOtpVerified || isSendingOtp}
                  className={`px-4 py-2 rounded-md text-sm font-medium transition duration-200 ${
                    !formData.email || errors.email || isOtpVerified || isSendingOtp
                      ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                      : 'bg-blue-600 text-white hover:bg-blue-700'
                  }`}
                >
                  {isSendingOtp ? 'Sending...' : isOtpVerified ? 'Verified ✓' : 'Get OTP'}
                </button>
              </div>
            ...
            {isOtpSent && !isOtpVerified && (
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                {otpError && (
                  <div className={`text-sm mt-2 ${otpError.includes('successfully') ? 'text-green-600' : 'text-red-500'}`}>
                    {otpError}
                  </div>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} ${touched.dob && errors.dob ? 'border-red-500' : ''}`}
                />
                {touched.dob && errors.dob && <div className={errorClass}>{errors.dob}</div>}
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} ${touched.gender && errors.gender ? 'border-red-500' : ''}`}
                >
                ...
                {touched.gender && errors.gender && <div className={errorClass}>{errors.gender}</div>}
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className={`${inputClass} ${touched.occupation && errors.occupation ? 'border-red-500' : ''}`}
                placeholder="Enter your occupation"
              />
              {touched.occupation && errors.occupation && <div className={errorClass}>{errors.occupation}</div>}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} ${touched.phoneNumber && errors.phoneNumber ? 'border-red-500' : ''}`}
                  placeholder="Enter phone number"
                />
                {touched.phoneNumber && errors.phoneNumber && <div className={errorClass}>{errors.phoneNumber}</div>}
              </div>

              <div>
                <label htmlFor="idCard" className={labelClass}>ID Card Number *</label>
                <input
                  type="text"
                  id="idCard"
                  name="idCard"
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} ${touched.idCard && errors.idCard ? 'border-red-500' : ''}`}
                  placeholder="Enter ID card number"
                />
                {touched.idCard && errors.idCard && <div className={errorClass}>{errors.idCard}</div>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} ${touched.password && errors.password ? 'border-red-500' : ''}`}
                ...
                {touched.password && errors.password && <div className={errorClass}>{errors.password}</div>}
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`${inputClass} ${touched.confirmPassword && errors.confirmPassword ? 'border-red-500' : ''}`}
                ...
                {touched.confirmPassword && errors.confirmPassword && <div className={errorClass}>{errors.confirmPassword}</div>}
              </div>
            </div>
