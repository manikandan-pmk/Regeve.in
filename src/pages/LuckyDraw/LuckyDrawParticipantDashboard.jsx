  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 p-4 md:p-8">
      ...
      {winnersList.length > 0 && (
        <div className="bg-gradient-to-br from-white to-purple-50/30 rounded-3xl shadow-2xl border border-purple-100 p-6 md:p-8 mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Celebrating our {winnersList.length} lucky winners! 🎉
                </p>
              </div>
            </div>
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
            >
              <FaDownload />
              Export Winners
            </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {winnersList.slice(0, 8).map((winner, index) => (
              <div
                key={winner.id}
                className="bg-white rounded-2xl border border-gray-100 hover:border-purple-200 hover:shadow-xl transition-all duration-500 p-5 group backdrop-blur-sm bg-white/80"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <div className="w-14 h-14 rounded-full overflow-hidden border-3 border-white shadow-lg bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                        {winner.photo ? (
                          <img
                            src={winner.photo}
                            alt={winner.name}
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        ID: {winner.luckyDrawId}
                      </p>
                    </div>
                  </div>
                  <button
                    onClick={() => resetWinner(winner.documentId)}
                    className="opacity-0 group-hover:opacity-100 p-2 text-gray-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-all duration-300"
                    title="Remove winner"
                  >
                    <FaTimes />
                  </button>
